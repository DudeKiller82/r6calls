    ...
    return {
      ...
      bartlett: {
        ...
        roomLabels: [
          ...
          // 1F
          { floor: 1, top: 186, left: -261, description: bartlettTerms.readingRoom, site: true, bomb: true },
          { floor: 1, top: 9, left: -254, description: bartlettTerms.lowerLibrary, site: true, hostage: true, bomb: true, secure: true },
          ...
          { floor: 1, top: -247, left: 583, description: bartlettTerms.kitchen, site: true, hostage: true, bomb: true },
          ...
          { floor: 1, top: 76, left: 567, description: bartlettTerms.pianoRoom, site: true, bomb: true },
          { floor: 1, top: 140, left: 253, description: bartlettTerms.lounge, site: true, secure: true },
          ...
          // 2F
          { floor: 2, top: 9, left: -254, description: bartlettTerms.upperLibrary, site: true, bomb: true, secure: true },
          ...
          { floor: 2, top: 164, left: -207, description: bartlettTerms.classroom, site: true, bomb: true, secure: true },
          ...
          { floor: 2, top: 185, left: 344, description: bartlettTerms.mainOffice, site: true, hostage: true },
          { floor: 2, top: 90, left: 654, description: bartlettTerms.rowingMuseum, site: true, bomb: true },
          { floor: 2, top: 37, left: 389, description: bartlettTerms.modelHall, site: true, secure: true },
          { floor: 2, top: -61, left: 577, description: bartlettTerms.trophyRoom, site: true, hostage: true, bomb: true },
      ...
      coastline: {
        ...
        roomLabels: [
          ...
          { floor: 1, top: 47, left: 44, description: coastlineTerms.kitchen, site: true, hostage: true, bomb: true, secure: true },
      ...
      favela: {
        ...
        roomLabels: [
          ...
          // 1F
          { floor: 1, top: -178, left: -213, description: favelaTerms.armoryRoom, site: true, secure: true },
          { floor: 1, top: 210, left: -159, description: favelaTerms.auntsApartment, site: true, bomb: true, secure: true },
          { floor: 1, top: 173, left: -61, description: favelaTerms.auntsApartment, site: true, bomb: true, secure: true },
          { floor: 1, top: -49, left: -162, description: favelaTerms.bikersApartment, site: true, hostage: true , bomb: true},
          { floor: 1, top: 44, left: -340, description: favelaTerms.bikersBedroom, site: true, bomb: true },
          ...
          // 2F
          { floor: 2, top: 9, left: -130, description: favelaTerms.footballApartment, site: true, secure: true },
          { floor: 2, top: 190, left: -42, description: favelaTerms.auntsBedroom, site: true, hostage: true, bomb: true },
          { floor: 2, top: -205, left: -191, description: favelaTerms.growRoom, site: true, hostage: true },
          { floor: 2, top: -253, left: 95, description: favelaTerms.methLab, site: true, bomb: true },
          { floor: 2, top: -69, left: -321, description: favelaTerms.footballBedroom, site: true, bomb: true },
      ...
      fortress: {
        ...
        roomLabels: [
          ...
          { floor: 1, top: 156, left: -140, description: fortressTerms.hammam, site: true, hostage: true, bomb: true },
          { floor: 1, top: 255, left: -243, description: fortressTerms.hammam, site: true, hostage: true, bomb: true },
          ...
          { floor: 1, top: 154, left: 120, description: fortressTerms.cafeteria, site: true, bomb: true, secure: true },
          ...
          { floor: 1, top: 39, left: 2, description: fortressTerms.kitchen, site: true, hostage: true, bomb: true },
          ...
          { floor: 1, top: -35, left: -207, description: fortressTerms.sittingRoom, site: true, bomb: true },
          { floor: 1, top: -60, left: -35, description: fortressTerms.diningRoom, site: true, secure: true },
          ...
          { floor: 2, top: 230, left: 40, description: fortressTerms.dormitory, site: true, bomb: true, secure: true },
          { floor: 2, top: 132, left: 120, description: fortressTerms.dormitory, site: true, bomb: true, secure: true },
          { floor: 2, top: 232, left: 162, description: fortressTerms.gamesRoom, site: true, hostage: true },
          { floor: 2, top: 128, left: -7, description: fortressTerms.centralStairs },
          { floor: 2, top: 62, left: 200, description: fortressTerms.briefingRoom, site: true, bomb: true },
          ...
          { floor: 2, top: 2, left: 0, description: fortressTerms.bathroom, site: true, hostage: true },
          { floor: 2, top: -98, left: -120, description: fortressTerms.commandersOffice, site: true, bomb: true, secure: true },
      ...
      plane: {
        ...
        roomLabels: [
          ...
          { floor: 2, top: -37, left: 247, description: planeTerms.frontHallway },
      ...
      villa: {
        ...
        roomLabels: [
          ...
          { floor: 0, top: -190, left: 371, description: villaTerms.artStorage, site: true },
          { floor: 0, top: -219, left: 466, description: villaTerms.oldOffice, site: true },
          ...
          { floor: 1, top: 127, left: 165, description: villaTerms.library, site: true },
          { floor: 1, top: 44, left: 135, description: villaTerms.library, site: true },
          ...
          { floor: 1, top: 72, left: 319, description: villaTerms.pianoRoom, site: true },
          { floor: 1, top: 50, left: 204, description: villaTerms.gallery },
          { floor: 1, top: -26, left: 113, description: villaTerms.toilet },
          { floor: 1, top: -34, left: 229, description: villaTerms.livingRoom, site: true },
          { floor: 1, top: -139, left: 279, description: villaTerms.livingRoom, site: true },
          ...
          { floor: 1, top: -247, left: 480, description: villaTerms.diningRoom, site: true },
          { floor: 1, top: -250, left: 337, description: villaTerms.chinaRoom },
          { floor: 1, top: -312, left: 371, description: villaTerms.kitchen, site: true },
          ...
          { floor: 2, top: 184, left: 350, description: villaTerms.study, site: true },
          { floor: 2, top: 70, left: 165, description: villaTerms.gamesRoom, site: true },
          { floor: 2, top: 160, left: 191, description: villaTerms.bar },
          { floor: 2, top: 108, left: 320, description: villaTerms.aviatorRoom, site: true },
          ...
          { floor: 2, top: -159, left: 447, description: villaTerms.statuaryRoom, site: true },
          { floor: 2, top: -227, left: 291, description: villaTerms.trophyRoom, site: true },
          { floor: 2, top: -228, left: 539, description: villaTerms.masterBedroom, site: true },
          { floor: 2, top: -317, left: 296, description: villaTerms.astronomyRoom, site: true },
