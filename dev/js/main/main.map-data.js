    ...
    return {
      ...
      kanal: {
        ...
        roomLabels: [
          ...
          { floor: 1, top: -101, left: -175, hardToRead: true, description: kanalTerms.radioRoomHallway, rotate: -90 },
          ...
          { floor: 0, top: -147, left: -178, hardToRead: true, description: kanalTerms.supplyRoomCorridor.replace(new RegExp('<br/>'), ' '), rotate: -90 },
          { floor: 0, top: 72, left: -219, hardToRead: true, description: kanalTerms.supplyRoomCorridor },
